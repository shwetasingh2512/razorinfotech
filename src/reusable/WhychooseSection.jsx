      ...
      <div className="max-w-full sm:max-w-4xl md:max-w-6xl lg:max-w-7xl mx-auto">
        <header className="mb-6 sm:mb-8">
          ...
          <p className="text-base sm:text-base md:text-lg text-paragraph max-w-full sm:max-w-xl md:max-w-2xl mt-3 sm:mt-4">
            We are the leading service provider serving as your long-term partner. Our approach combines expertise, technology, and strategy that serve your unique needs. Get seamless solutions to grow your business.
          </p>
        </header>
