    ...
    return (
        <>
            ...
            <section className="group p-20 bg-accent">
                <h4 className="border text-heading py-2 px-4 text-xl w-fit mx-auto rounded-3xl">Work Process</h4>
                        ...
                        cards.map((e, i) => {
                            ...
                            return (
                                <div className={`p-5 rounded-3xl border text-center h-66 border-border ${i % 2 == 0 ? "text-white" : "group-hover:bg-background text-white"}`} key={i}>
                                    ...
                                    <h2 className="text-heading text-xl mt-5">{e.title}</h2>
                                    <p className="text-md text-paragraph max-w-3/5 mx-auto mt-5">{e.description}</p>
                                </div>
                            )
                        })
                    }
            ...
            <section className="linear-gradient">
                <div className="mx-auto max-w-6xl px-6 py-12 md:py-16">
                    <div className="flex flex-col items-center text-center">
                        <span className="inline-flex items-center gap-2 rounded-full border border-[var(--color-paragraph)]/20 bg-[var(--color-accent)] px-3 py-1 text-lg  text-[var(--color-paragraph)]/70">
                            Our Services
                        </span>
